    ...
    <div className="preview-container">
      ...
      <div className="preview-cards">
        ...
        <div className="preview-card">
          ...
          <p>
            <strong>Aadhaar No:</strong> {formData.aadhaarNo || "-"}
          </p>
        ...
        <div className="preview-card">
          ...
          <p>
            <strong>Guardian Contact:</strong> {formData.guardianContact || "-"}
          </p>
          <p>
            <strong>Guardian Aadhaar:</strong> {formData.guardianAadhaar || "-"}
          </p>
          <p>
            <strong>Guardian Email:</strong> {formData.guardianEmail || "-"}
          </p>
        ...
        <div className="preview-card">
          ...
          <p>
            <strong>Post Office:</strong> {formData.postOffice || "-"}
          </p>
          <p>
            <strong>Ward No:</strong> {formData.wardNo || "-"}
          </p>
          <p>
