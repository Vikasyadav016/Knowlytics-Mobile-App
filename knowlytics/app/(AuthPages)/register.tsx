...
export default function Register() {
  ...
  // State for screen width to handle rotation or dimension changes
    ...
    >
      ...
      >
        <View style={[styles.card, { width: cardWidth }]}>
          ...
          <View style={[styles.formRow, isLargeScreen && { flexDirection: "row" }]}>
            <View style={[styles.inputWrapper, isLargeScreen && styles.halfWidth]}>
              <Text style={styles.label}>Full Name</Text>
              <TextInput
                style={styles.input}
...
const styles = StyleSheet.create({
  card: {
    ...
    borderRadius: 12,
    padding: 30,
    // // No static width here
    // maxWidth: 400, // Keep max width limit to avoid very wide cards
    alignSelf: "center",
    shadowColor: "#000",
    shadowOffset: { width: 0, height: 3 },
    shadowOpacity: 0.2,
